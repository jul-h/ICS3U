...
public class StrangerGame { 
	...
	public static void text(String data) throws InterruptedException{
		for (int i = 0; i < data.length(); i++) {
			...
			c.setTextBackgroundColor(transparent);
	...
	*/
	...
	public static void main(String[] args) throws InterruptedException {
		...
		do { 
			...
			c.drawImage(jpgStreet, -100, 100, 941, 628, null);
			c.setTextColor(Color.black);
			text("It's a cold winter night... "
					+ "You and your friend were just on your way home from a movie, when "
					+ '\n'+ "suddenly, you realize that you guys need bus fare. What do you do?" 
					+ '\n');
			c.setTextColor(new Color(0, 204, 204));
			text("a)");
			c.setTextColor(Color.black);
			text(" Find an ATM." + '\n');
			c.setTextColor(new Color(0, 204, 204));
			...
			if (input.equalsIgnoreCase("a")) {
				...
				//insert footsteps audio
				text("The mysterious man follows you. What do you do?" + '\n');
				c.setTextColor(new Color(0, 204, 204)); // change text color to blue
				text("a)");
				c.setTextColor(Color.black);
				text(" Ignore him." + '\n');
				c.setTextColor(new Color(0, 204, 204));
				...
				if (input.equalsIgnoreCase("a")) {
					...
					//insert knife stabbing sounds, screaming
					...
					if (input.equalsIgnoreCase("a")) {
						...
						if (input.equalsIgnoreCase("a")) {
							...
							int x = (int) (Math.random() * 2 + 1);
							if (x == 1) {
								//insert man in handcuffs
								//insert handcuffs sound??
								text("The man is apprehended, and you get your stuff back." + '\n'); //ending
								Thread.sleep(1000);
							} else {
								//insert hospital pic
								//insert hospital heart monitor beeping sound thing??
				...
				if (x == 1) {
					//insert two people on snowy street
					text("You and your friend get your bus fare and go home." + '\n'); //ending
				} else {
					c.clear();
					//insert man with knife in snowy street
					//insert knife sound
					...
					if (input.equalsIgnoreCase("a")) {
						c.clear();
						//insert strangerKnife with running man in background
						//insert running sound, knife stabbing, screaming
						...
						c.drawImage(jpgHostage, 160, 55, 429, 644, null);
						...
						if (input.equalsIgnoreCase("a")) {
							...
							if (input.equalsIgnoreCase("a")) {
								...
								for (int i = 0; i < 3; i++) {
									...
									if (guess == x) {
										//insert two people leaving alleyway/snowy street
										i = 4;
										c.clear();
										...
										if (i == 2){
											...
											c.drawImage(jpgStrangerKnife, 0, 100, 782, 722, null);
											//insert knife stabbing sound, screaming
								...
								if (input.equalsIgnoreCase("a")) {
									...
									for (int i = 0; i < 3; i++) {
										...
										if (input.equalsIgnoreCase("a")) {
											...
											x = (int) (Math.random() * 9);
											if (x <= weaponStrength) {
												//insert two people walking out of alleyway
											...
											c.clear();
											//insert strangerKnife with man in background with a baseball bat 
											//insert knife stabbing sound, screaming
